    ...
    <footer className="s-footer">
      <div className="row row-y-top">
          ...
          <div className="row">
            <div className="column large-7 tab-12 s-footer__block">
              ...
              <p>
                ...
                Mirembe Arcade <br />
                Kampala Uganda <br />
                <a href="tel:+256705574060">+256 705 574 060</a><br/>
                <a href="tel:+256777111200">+256 777 111 200</a>
              </p>
            </div>
            ...
            <div className="column large-5 tab-12 s-footer__block">
              ...
              <ul className="s-footer__list">
                ...
                <li>
                  <a href="https://wa.me/+256777111200">Whatsapp</a>
                </li>
                <li>
        ...
        <div className="column large-4 medium-12 s-footer__block--end">
          <a
            href="mailto:goodnewsashaba@gmail.com"
            className="btn h-full-width"
          >
            Let's Talk
          </a>
